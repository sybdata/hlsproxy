# hlsproxy
 ...
 Распакуйте архив в отдельную папку
    ...
    Измените значение playlists.uri на ссылку из личного кабинета на сайте Торрент-ТВ.

    !!! Важно
    Если вы изменяете настройки в личном кабинете и хотите, чтобы эти изменения отражались в плейлисте прокси, вам нужно
    снова скопировать её из личного кабинета в json файл.
    После этого зайдите на страницу /status и нажмите обновить плейлист)
    !!!
